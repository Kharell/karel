                  ...
                  <div className="relative pl-8 before:absolute before:left-0 before:top-2 before:bottom-0 before:w-px before:bg-gradient-to-b before:from-blue-500 before:to-transparent">
                    ...
                    <div className="grid grid-cols-2 gap-3">
                      <div className="bg-slate-900/50 p-3 rounded-2xl border border-white/5">
                        ...
                        <p className="text-sm font-bold text-white">S.Kom</p>
                      </div>
                      <div className="bg-slate-900/50 p-3 rounded-2xl border border-white/5">
                        <p className="text-[10px] text-slate-500 uppercase">
                          IPK
      ...
      <section id="contact" className="py-16 md:py-24 px-4 sm:px-6">
        <div className="max-w-6xl mx-auto glass p-8 md:p-16 rounded-[2rem] sm:rounded-[3rem] text-center overflow-hidden relative border border-slate-800 shadow-2xl">
          ...
          <div className="relative z-10 flex flex-col gap-4 sm:gap-6">
            {/* Baris Atas: 3 Kolom (Email, WA, LinkedIn) */}
            ...
            {/* Baris Bawah: 2 Kolom di Tengah (GitHub, Instagram) */}
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6 max-w-2xl mx-auto w-full">
              ...
              {/* Instagram */}
              <a
                href="https://www.instagram.com/k4r3l.js/"
                target="_blank"
                rel="noopener noreferrer"
                className="p-6 bg-slate-900/50 backdrop-blur-sm border border-slate-800 rounded-3xl hover:scale-105 transition-all group hover:border-pink-500/40 shadow-sm">
                <div className="w-12 h-12 bg-pink-500/10 rounded-2xl flex items-center justify-center mx-auto mb-4 group-hover:bg-pink-500/20 group-hover:scale-110 transition-all">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                ...
                <p className="font-bold text-xs text-slate-200">@k4r3l.js</p>
              </a>
            </div>
          </div>
        </div>
